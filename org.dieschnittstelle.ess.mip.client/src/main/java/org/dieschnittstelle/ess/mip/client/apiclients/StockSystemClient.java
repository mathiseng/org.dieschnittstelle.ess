...
public class StockSystemClient implements StockSystem {
    ...
    //Produkte die für gegebene Verkaufsstelle vorhanden sind
    @Override
...
//		return new ArrayList<>();
    ...
    //Wenn posId nicht gesetzt , dann diese Methode aufrufen, ansonsten getProductsOnStock
    @Override
...
//        return new ArrayList<>();
 ...
 //       return 0;
    ...
    // Wo gibt es das Produkt in welcher Anzahl
    @Override
